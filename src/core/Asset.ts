...
export const ASSET_CONFIGS: AssetConfig[] = [
  ...
  // ── Penny Stock Exchange ────────────────────────────────────────────────────
  {
    ...
    risk: 0.95,
    hypeDecay: 0.96,
    carryingCost: 0.000200,
    unlockThreshold: 999_999_999,
    description: "It's worth almost nothing. That's the appeal.",
    archetype: 'MAX CHAOS',
    archetypeClass: 'arch-chaos',
    buyReason: 'Buy thousands of shares for pennies. Can 50× or go to zero in a day. Pure degen.',
  },
  {
    id: 'lottery_token',
    name: 'LotteryToken',
    ...
    hypeDecay: 0.94,
    unlockThreshold: 999_999_999,
    description: 'Technically a financial instrument. Technically.',
    archetype: 'HYPE RIDER',
    archetypeClass: 'arch-hype',
    buyReason: 'Hype spikes are violent and fast. Get in, spike up, get out before the crash.',
  },
  {
    id: 'hopium_pills',
    name: 'HopiumDAO',
    ...
    risk: 0.75,
    hypeDecay: 0.97,
    carryingCost: 0.000100,
    unlockThreshold: 999_999_999,
    description: 'Backed by pure hope and absolutely nothing else.',
    archetype: 'CHAOS',
    archetypeClass: 'arch-chaos',
    buyReason: 'Negative trend but strong hype spikes. Event-trade only — bleeding value daily.',
  },
  ...
  // ── Tech Ventures ───────────────────────────────────────────────────────────
  {
    ...
    hypeDecay: 0.992,
    unlockThreshold: 999_999_999,
    description: 'Quantitative research meets meme culture.',
    archetype: 'STEADY HOLD',
    archetypeClass: 'arch-steady',
    buyReason: 'Strong upward trend with medium stability. Buy the dips, hold for steady gains.',
    dividendRate: 0.0005,
  },
  {
    id: 'vr_headspace',
    ...
    hypeDecay: 0.975,
    unlockThreshold: 999_999_999,
    description: 'The metaverse was a joke. This is something else.',
    archetype: 'BLENDED',
    archetypeClass: 'arch-blend',
    buyReason: 'Good hype response plus positive trend. Balanced play — hold or trade spikes.',
  },
  {
    id: 'battery_farm',
    name: 'BatteryFarm',
    ...
    hypeDecay: 0.996,
    unlockThreshold: 999_999_999,
    description: 'Clean energy meets passive income. Boring = beautiful.',
    archetype: 'STEADY HOLD',
    archetypeClass: 'arch-steady',
    buyReason: 'Highest stability in Tech Ventures. Slow and steady compounder. Best dividends here.',
    dividendRate: 0.0008,
  },
  ...
  // ── Blue Chip Index ─────────────────────────────────────────────────────────
  {
    ...
    hypeDecay: 0.998,
    unlockThreshold: 999_999_999,
    description: 'A bank so boring it invented beige. Up every year for 40 years.',
    archetype: 'BLUE CHIP',
    archetypeClass: 'arch-blue',
    buyReason: 'Ultra-safe dividend machine. Tiny volatility, steady growth. The millionaire\'s parking spot.',
    dividendRate: 0.0018,
  },
  {
    id: 'megacorp_etf',
    ...
    hypeDecay: 0.999,
    unlockThreshold: 999_999_999,
    description: 'A basket of every corporation that controls your life.',
    archetype: 'BLUE CHIP',
    archetypeClass: 'arch-blue',
    buyReason: 'Maximum stability. Highest dividends in the game. Buy and never look at it again.',
    dividendRate: 0.0022,
  },
  ...
  // ── Underground Exchange ────────────────────────────────────────────────────
  {
    ...
    risk: 0.98,
    hypeDecay: 0.95,
    carryingCost: 0.000180,
    unlockThreshold: 999_999_999,
    description: 'No whitepaper. No team. Just vibes and encrypted wallets.',
    archetype: 'MAX CHAOS',
    archetypeClass: 'arch-chaos',
    buyReason: 'Extreme hype, extreme risk. Can 20× in a day. Can also cease to exist.',
  },
  {
    id: 'dark_matter_token',
    name: 'Dark Matter',
    emoji: '🌑',
    basePrice: 500,
    volatility: 0.12,
    ...
    risk: 0.88,
    hypeDecay: 0.96,
    carryingCost: 0.000150,
    unlockThreshold: 999_999_999,
    description: 'Scientists say dark matter doesn\'t interact with anything. Traders disagree.',
    archetype: 'CHAOS',
    archetypeClass: 'arch-chaos',
    buyReason: 'Event-trade only. Event pumps are legendary. Bleeds value hard between catalysts.',
  },
  {
    id: 'anon_protocol',
    name: 'AnonProtocol',
    ...
    hypeDecay: 0.97,
    unlockThreshold: 999_999_999,
    description: 'Privacy-focused. Too privacy-focused. The founders are anonymous. The code is anonymous.',
    archetype: 'HIGH RISK',
    archetypeClass: 'arch-highrisk',
    buyReason: 'Positive trend but brutal shocks. Best risk/reward in Underground with a long time horizon.',
    dividendRate: 0.0004,
  },
];
